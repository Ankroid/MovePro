    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              About <span className="text-blue-600">MovePro</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We&apos;re a trusted name in the moving industry, committed to making your relocation experience smooth and stress-free.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Founded in 2014, MovePro started with a simple mission: to make moving less stressful for families and businesses. 
                What began as a small local moving company has grown into a trusted partner for thousands of satisfied customers.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                Our team of experienced professionals understands that every move is unique. Whether you&apos;re moving across town or 
                across the country, we treat your belongings with the same care we would our own.
              </p>
              <p className="text-lg text-gray-600">
                Today, we&apos;re proud to serve communities across the region with our comprehensive moving services, always maintaining 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">The professionals behind our success</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">15+ years in the moving industry</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Ensures smooth operations</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-blue-600 font-medium mb-2">Lead Mover</p>
              <p className="text-gray-600">Expert in handling delicate items</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">We always do what&apos;s right, even when no one is watching.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">We treat your belongings with the same care as our own.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Move?</h2>
          <p className="text-xl text-blue-100 mb-8">Let us help you with your next move</p>
